            ...
            {activeTab === "settings" ? (
              <div className="space-y-8 p-5 sm:p-6">
                ...
                <form action={updateSiteBookingSettings} className="grid gap-4 border-t border-[var(--line)] pt-7 sm:grid-cols-2">
                  ...
                  <label className="flex items-center gap-3 rounded-xl border border-[var(--line)] px-4 py-3 text-xs font-bold"><input name="onlinePaymentEnabled" type="checkbox" defaultChecked={selectedSite.onlinePaymentEnabled} /> Maya online payment</label>
